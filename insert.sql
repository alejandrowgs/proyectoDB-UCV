...
('Ensalada de Frutas Preparadas', 141417149, 'Ensalada de frutas lista para comer', 'PorUnidad', 4.00, 0, 30, 15),
  --Productos para mas marcas
('GAMA Aceite', 12345678923, 'Aceite de cocina GAMA', 'PorUnidad', 5.00, 0, 1, 21),
('Empresas Polar Harina PAN', 12345678924, 'Harina de maíz precocida', 'PorUnidad', 2.50, 0, 1, 22),
('Los Andes Jugo de Naranja', 12345678925, 'Jugo de naranja natural', 'PorUnidad', 3.00, 0, 1, 23),
('La Castellana Salsa de Tomate', 12345678926, 'Salsa de tomate tradicional', 'PorUnidad', 1.50, 0, 1, 24),
('La Moderna Pasta', 12345678927, 'Pasta alimenticia de alta calidad', 'PorUnidad', 2.00, 0, 1, 25),
('Santa Teresa Ron', 12345678928, 'Ron venezolano', 'PorUnidad', 15.00, 0, 1, 26),
('Cacique Ron', 12345678929, 'Ron popular de Venezuela', 'PorUnidad', 12.00, 0, 1, 27),
('Venezuela Café', 12345678930, 'Café molido', 'PorUnidad', 8.00, 0, 1, 28),
('El Rey Chocolate', 12345678931, 'Chocolate de alta calidad', 'PorUnidad', 10.00, 0, 1, 29),
('Savoy Chocolate', 12345678932, 'Chocolates y dulces', 'PorUnidad', 5.00, 0, 1, 30),
('Puig Galletas', 12345678933, 'Galletas de panadería', 'PorUnidad', 3.00, 0, 1, 31),
('La Caroreña Sangría', 12345678934, 'Sangría y vinos', 'PorUnidad', 7.00, 0, 1, 32),
('La Fama Pan', 12345678935, 'Productos de panadería', 'PorUnidad', 2.00, 0, 1, 33),
('La Lucha Café', 12345678936, 'Café y productos de cafetería', 'PorUnidad', 6.00, 0, 1, 34),
('La Vaquita Leche', 12345678937, 'Leche y productos lácteos', 'PorUnidad', 4.00, 0, 1, 35),
('La Campiña Queso', 12345678938, 'Quesos y productos lácteos', 'PorUnidad', 5.00, 0, 1, 36),
('La Montaña Agua', 12345678939, 'Agua mineral', 'PorUnidad', 1.00, 0, 1, 37),
('La Sierra Agua', 12345678940, 'Agua purificada', 'PorUnidad', 1.00, 0, 1, 38),
('La Costa Pescado', 12345678941, 'Pescados frescos', 'PorPesoKg', 10.00, 0, 1, 39),
('La Selva Frutas', 12345678942, 'Frutas frescas', 'PorPesoKg', 3.00, 0, 1, 40),
('Leche Táchira Leche', 12345678943, 'Leche y derivados lácteos', 'PorUnidad', 4.00, 0, 1, 41),
('Parmalat Leche', 12345678944, 'Leche UHT', 'PorUnidad', 4.00, 0, 1, 42),
('Minalba Agua', 12345678945, 'Agua mineral', 'PorUnidad', 1.00, 0, 1, 43),
('Agua Manantial Agua', 12345678946, 'Agua purificada', 'PorUnidad', 1.00, 0, 1, 44),
('Diana Aceite', 12345678947, 'Aceites comestibles', 'PorUnidad', 5.00, 0, 1, 45),
('Mazola Aceite', 12345678948, 'Aceite de maíz', 'PorUnidad', 5.00, 0, 1, 46),
('Pomarrosa Salsa', 12345678949, 'Salsas y condimentos', 'PorUnidad', 2.00, 0, 1, 47),
('La Sibarita Gourmet', 12345678950, 'Productos gourmet', 'PorUnidad', 10.00, 0, 1, 48),
('La Giralda Panadería', 12345678951, 'Productos de panadería', 'PorUnidad', 3.00, 0, 1, 49),
('Ace Limpieza', 12345678952, 'Productos de limpieza', 'PorUnidad', 4.00, 0, 1, 50),
('Foca Detergente', 12345678953, 'Detergente en polvo', 'PorUnidad', 3.00, 0, 1, 51),
('Jabón Rey Jabón', 12345678954, 'Jabón de lavar', 'PorUnidad', 2.00, 0, 1, 52),
('Scott Higiene', 12345678955, 'Productos de higiene personal', 'PorUnidad', 5.00, 0, 1, 53),
('Toallas Nova Toallas', 12345678956, 'Toallas de papel', 'PorUnidad', 3.00, 0, 1, 54),
('Kraft Snacks', 12345678957, 'Productos alimenticios y snacks', 'PorUnidad', 4.00, 0, 1, 55),
('PepsiCo Bebidas', 12345678958, 'Bebidas y snacks', 'PorUnidad', 2.00, 0, 1, 56),
('Palmolive Higiene', 12345678959, 'Productos de higiene personal', 'PorUnidad', 5.00, 0, 1, 57),
('General Mills Alimentos', 12345678960, 'Productos alimenticios variados', 'PorUnidad', 4.00, 0, 1, 58),
('Marlboro Cigarrillos', 12345678961, 'Cigarrillos de distintos tipos', 'PorUnidad', 6.00, 0, 1, 59),
('Camel Cigarrillos', 12345678962, 'Cigarrillos de alta calidad', 'PorUnidad', 6.00, 0, 1, 60),
('Lucky Strike Cigarrillos', 12345678963, 'Cigarrillos de tabaco rubio', 'PorUnidad', 6.00, 0, 1, 61),
('Duracell Baterías', 12345678964, 'Baterías de larga duración', 'PorUnidad', 5.00, 0, 1, 62),
('Energizer Pilas', 12345678965, 'Pilas y baterías de calidad', 'PorUnidad', 5.00, 0, 1, 63),
('GAMA Arroz', 12345678966, 'Arroz blanco GAMA', 'PorUnidad', 1.50, 0, 1, 21),
('GAMA Frijoles', 12345678967, 'Frijoles negros GAMA', 'PorUnidad', 2.00, 0, 1, 21),
('GAMA Azúcar', 12345678968, 'Azúcar refinada GAMA', 'PorUnidad', 1.20, 0, 1, 21),
('GAMA Sal', 12345678969, 'Sal de mesa GAMA', 'PorUnidad', 0.80, 0, 1, 21),
('GAMA Harina', 12345678970, 'Harina de trigo GAMA', 'PorUnidad', 1.50, 0, 1, 21),
('GAMA Pasta', 12345678971, 'Pasta GAMA', 'PorUnidad', 1.80, 0, 1, 21),
('GAMA Leche', 12345678972, 'Leche en polvo GAMA', 'PorUnidad', 3.50, 0, 1, 21),
('GAMA Café', 12345678973, 'Café molido GAMA', 'PorUnidad', 4.00, 0, 1, 21),
('GAMA Té', 12345678974, 'Té negro GAMA', 'PorUnidad', 2.50, 0, 1, 21),
('GAMA Galletas', 12345678975, 'Galletas de vainilla GAMA', 'PorUnidad', 1.50, 0, 1, 21),
('GAMA Mermelada', 12345678976, 'Mermelada de fresa GAMA', 'PorUnidad', 2.00, 0, 1, 21),
('GAMA Mantequilla', 12345678977, 'Mantequilla GAMA', 'PorUnidad', 2.50, 0, 1, 21),
('GAMA Queso', 12345678978, 'Queso blanco GAMA', 'PorUnidad', 3.00, 0, 1, 21),
('GAMA Yogur', 12345678979, 'Yogur natural GAMA', 'PorUnidad', 1.80, 0, 1, 21),
('GAMA Helado', 12345678980, 'Helado de vainilla GAMA', 'PorUnidad', 3.50, 0, 1, 21),
('GAMA Jugo', 12345678981, 'Jugo de naranja GAMA', 'PorUnidad', 2.00, 0, 1, 21),
('GAMA Refresco', 12345678982, 'Refresco de cola GAMA', 'PorUnidad', 1.50, 0, 1, 21),
('GAMA Agua', 12345678983, 'Agua mineral GAMA', 'PorUnidad', 1.00, 0, 1, 21),
('GAMA Vino', 12345678984, 'Vino tinto GAMA', 'PorUnidad', 10.00, 0, 1, 21),
('GAMA Cerveza', 12345678985, 'Cerveza GAMA', 'PorUnidad', 2.00, 0, 1, 21);
